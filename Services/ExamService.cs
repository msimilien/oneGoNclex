...
namespace oneGoNclex.Services
{
    ...
    {
        public static (List<ExamQuestion> listOfQuestions,
            List<ExamAnswer> listOfAnswers,
            List<ExamAnswerExplanation> listOfExplanations)
            GetQuestionsByBankId(int bankID)
        {
